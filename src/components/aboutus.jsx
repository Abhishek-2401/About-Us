...
const AboutUs = () => {
  ...
  const sections = [
    ...
    },
    {
        ...
        callText: "+91 9087 6543 21",
        emailText: "campfly@gmail.com",
      },
    ...
    return (
      <div className="relative ">
        <div
          ...
          style={{
            backgroundImage: "url(group2214-bg.png)", 
            height: "auto",
            width : "100%" 
          }}
        >
              ...
              {section.heading === "Contact Us" && (
                <div className="mt-4 flex gap-8 mb-10 items-center justify-center">
                  <div className=" flex items-center">
                    <img src="call-vector.png" alt="Phone Icon" className="w-5 h-5 mr-2" />
                    <span className="text-[16px] sm:text-[16px] lg:text-[20px]">{section.callText}</span>
                  </div>
                  <div className="flex items-center">
                    <img src="email-vector.png" alt="Email Icon" className="w-5 h-4 mr-2" />
