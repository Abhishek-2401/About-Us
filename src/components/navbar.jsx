  ...
  return (
    <nav className="bg-white p-4">
      <div className="logo container mx-auto flex items-center justify-between">
        ...
        <div className="lg:flex items-center space-x-4 mr-28 ">
          ...
          <button className="bg-custom-green text-black font-medium px-6 py-1.5 rounded-lg hover:bg-black hover:text-[#1ed760]">
            Sign In
          </button>
        </div>
      </div>
